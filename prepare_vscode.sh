...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameLong" "Resonance Assistance"
  ...
  setpath "product" "win32AppUserModelId" "Resonance.ResonanceAssistance"
  setpath "product" "win32DirName" "Resonance Assistance"
  setpath "product" "win32MutexName" "resonance"
  setpath "product" "win32NameVersion" "Resonance Assistance"
  setpath "product" "win32RegValueName" "ResonanceAssistance"
